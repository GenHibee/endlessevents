        ...
        <div className="container py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-lg bg-gradient-primary flex items-center justify-center">
                  <svg className="w-5 h-5 text-primary-foreground" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M15 5v2h-3V5H8v2H5V5H3v14h2v-2h3v2h4v-2h3v2h4v-2h2V5h-2v2h-4V5h-3z"/>
                  </svg>
                </div>
              ...
              <p className="text-muted-foreground text-sm max-w-md">
                The Web3 event ticketing platform powered by Endless Protocol. 
                Create events, mint tickets, and earn proof of attendance NFTs.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="/my-tickets" className="hover:text-primary transition-colors">My Tickets</a></li>
                <li><a href="/my-poaps" className="hover:text-primary transition-colors">POAPs</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="#" className="hover:text-primary transition-colors">Move Contracts</a></li>
          ...
          <div className="mt-8 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © 2024 Endless Events. Built on Endless Protocol.
            </p>
